      ...
      <section className="py-16 sm:py-24">
        <div className="w-[85%] max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-[family-name:var(--font-playfair)] text-[#081F4D] mt-3 mb-4">
              All Destinations
            </h1>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#F8F7F4] flex items-center justify-center">
        <div className="w-8 h-8 rounded-full border-2 border-[#D4A24C] border-t-transparent animate-spin" />
      </div>
    }>
      <DestinationsContent />
    </Suspense>
